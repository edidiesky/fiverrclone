...
export const getAllGigs = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    try {
      ...
      let GigsUrl = `${import.meta.env.VITE_API_BASE_URLS}api/v1/gig`;
      if (sort) {
...
export const getSingleGigsDetails = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    try {
      const { data } = await axios.get(`${import.meta.env.VITE_API_BASE_URLS}api/v1/gig/${name}`);
...
export const CreateSingleGig = createAsyncThunk(
  ...
  async ({ GigsData }, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.post(`${import.meta.env.VITE_API_BASE_URLS}api/v1/gig`, GigsData, config);
...
export const UpdateGig = createAsyncThunk(
  ...
  async ({ GigsData }, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.put(`${import.meta.env.VITE_API_BASE_URLS}api/v1/gig/${_id}`, GigsData, config);
...
export const DeleteGig = createAsyncThunk(
  ...
  async (Gigsid, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.delete(`${import.meta.env.VITE_API_BASE_URLS}api/v1/gig/${Gigsid}`, config);
      return Gigsid;
    } catch (error) {
      return thunkAPI.rejectWithValue(
        error.response && error.response.data.message
  ...
  async ({ Reviewdata, id }, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `${import.meta.env.VITE_API_BASE_URLS}api/v1/gig/review/${id}`,
        Reviewdata,
        config
      );
      return data.message;
...
export const getTopRatedGigs = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.get(`${import.meta.env.VITE_API_BASE_URLS}api/v1/gig/rated`, config);
...
export const getGigsStats = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.get(`${import.meta.env.VITE_API_BASE_URLS}api/v1/gig/stats`, config);
      return data.stats;
    } catch (error) {
      return thunkAPI.rejectWithValue(
        error.response && error.response.data.message
