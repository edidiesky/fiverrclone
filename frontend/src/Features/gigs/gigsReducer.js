...
export const getSingleGigsDetails = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    try {
      const { data } = await axios.get(`/gig/${name}`);
...
export const CreateSingleGig = createAsyncThunk(
  ...
  async ({ GigsData }, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.post(`/gig`, GigsData, config);
...
export const UpdateGig = createAsyncThunk(
  ...
  async ({ GigsData }, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.put(`/gig/${_id}`, GigsData, config);
...
export const DeleteGig = createAsyncThunk(
  ...
  async (Gigsid, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.delete(`/gig/${Gigsid}`, config);
      return Gigsid;
    } catch (error) {
      return thunkAPI.rejectWithValue(
        error.response && error.response.data.message
...
export const getTopRatedGigs = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.get(`/gig/rated`, config);
...
export const getGigsStats = createAsyncThunk(
  ...
  async (name, thunkAPI) => {
    ...
    try {
      ...
      const { data } = await axios.get(`/gig/stats`, config);
      return data.stats;
    } catch (error) {
      return thunkAPI.rejectWithValue(
        error.response && error.response.data.message
